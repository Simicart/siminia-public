...
const Brands = props => {
    ...
    const color =
        brandConfiguration && brandConfiguration.color
            ? brandConfiguration.color
            : `#F69435`;
    ...
    const handleFilter = dictionary => {
        ...
        if (filterEle) {
            ...
            filterEle.style.color = '#F69435';
        }
        const filterDictionary =
            dictionary === 'all' ? dictionary : `.${dictionary}`;
    ...
    if (brandConfiguration) {
        ...
        brand_list_logo_height = brandConfiguration.brand_list_logo_height
            ? brandConfiguration.brand_list_logo_height
            : 150;
        brand_list_logo_width = brandConfiguration.brand_list_logo_width
            ? brandConfiguration.brand_list_logo_width
            : 150;
        if (brandConfiguration.brandlist_style === 1) showAlphabet = true;
        if (brandConfiguration.show_description) show_description = true;
    ...
    if (brandsList && brandsList.length) {
        ...
        brandsList.map((item, index) => {
            ...
            if (
                ...
                brandListItems.push(
                    <div
                        className={classes.alphabetHeader}
            ...
            const urlKey =
                ...
                (item.url_key
                    ? item.url_key
                    : item.default_value.toLowerCase()) +
                '.html';
            const location = {
                pathname: urlKey,
                state: {
            ...
            brandListItems.push(
                <React.Fragment key={index}>
                    <div
                        key={item.brand_id}
                        className={`mix ${firstChar} ${classes.brandItem}`}
                    >
                        <div
                            className={classes.brandItemInfo}
                            style={{ width: 240 }}
                        >
                            {(displayOption === 1 || displayOption === 0) && (
                                <Link
                                    className={classes.brandItemLink}
                                    to={location}
                                >
                                    <span
                                        className={
                                    ...
                                    >
                                        <span
                                            className={
                                                classes.productImageWrapper
                                            }
                                            style={{ paddingBottom: '125%' }}
                                        >
                                            <img
                                                className={
                                                    classes.productImagePhoto
                                                }
                            ...
                            {(displayOption === 1 || displayOption === 2) && (
                                <div className={classes.brandItemDetail}>
                                    ...
                                    {!!(
                                        ...
                                        <div
                                            className={
                                                classes.listItemSortDescription
                                            }
                                        >
                                            {item.short_description}
                                        </div>
                    ...
                    {(index + 1) % 3 === 0 && (
                        <div
                            key={randomString(3) + index}
                            className={classes.hr3}
                        />
                    )}
                    {(index + 1) % 4 === 0 && (
                        <div
                            key={randomString(3) + index}
                            className={classes.hr4}
                        />
                    )}
                    {(index + 1) % 7 === 0 && (
                        <div
                            key={randomString(3) + index}
                            className={classes.hr7}
                        />
                    )}
                    {(index + 1) % 8 === 0 && (
                        <div
                            key={randomString(3) + index}
                            className={classes.hr8}
                        />
                    )}
                    {(index + 1) % 9 === 0 && (
                        <div
                            key={randomString(3) + index}
                            className={classes.hr9}
                        />
                    )}
                </React.Fragment>
            );
    ...
    const dictionaryOptions = 'abcdefghijklmnopqrstuvwxyz'
        .split('')
        .map((dictionaryOption, index) => {
            const style = {
                color: '#777',
                opacity: '0.5',
                cursor: 'not-allowed'
            ...
            return (
                <div
                    ...
                    className={`${
                        classes.dictOption
                    } brand-filter brand-filter-${dictionaryOption.toUpperCase()}`}
                    style={style}
                >
                    {' '}
                    <span>{dictionaryOption.toUpperCase()}</span>
                </div>
            );
        });

    const listTitle =
        brandConfiguration && brandConfiguration.brand_list_name
            ? brandConfiguration.brand_list_name
            : `Brands`;
    const breadcrumbs = [
        {
            ...
            <div className={classes.brandContainer}>
                ...
                >
                    ...
                    <div className={classes.brandPageHeaderContent}>
                        <div
                            className={classes.brandPageSearchBox}
                            ref={searchWrapper}
                        >
                            <div>
                                <input
                                    ...
                                    className={`${
                                        classes.brandPageSearchInput
                                    } ${
                                        Identify.isRtl()
                                            ? classes.brandPageSearchInputRTL
                                            : ''
                                    }`}
                                    onChange={e =>
                                        setBrandSearchString(e.target.value)
                                    }
                                    onClick={e => handleClickInput(e)}
                                    placeholder={formatMessage({
                                        id: 'brands.search',
                                        defaultMessage: 'Search a brand name'
                                    })}
                                />
                                <div
                                    className={classes.brandPageIcon}
                                    onClick={toogleClickIcon}
                                >
                                    <Icon src={SearchIcon} />
                                </div>
                            </div>
                ...
                <div className={classes.dictList}>
                    <div className={classes.dictListWrapper}>
                        <div
                            ...
                            className={`brand-filter brand-filter-all ${
                                classes.dictOption
                            }`}
                            key="all"
                            style={{
                ...
                <div
                    className={`${classes.brandListContent} brand-list-content`}
                >
                    {brandListItems}
                </div>
            </div>
