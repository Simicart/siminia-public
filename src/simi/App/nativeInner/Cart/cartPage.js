...
const CartPage = props => {
    ...
    const { component: loadingComponent, setLoading } = useLoading();

    const setIsCartUpdating = useCallback(
        (v, setGlobalLoading = true) => {
    ...
    const [displayOutOfStockLabel, _setDisplayOutOfStockLabel] = useState(
        false
    );
