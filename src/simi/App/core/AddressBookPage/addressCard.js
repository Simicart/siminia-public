...
const AddressCard = props => {
    ...
    return (
        <div  className={defaultBadge ? classes.defaultAddressWrapper : null}>
            {defaultBadge ? 
            <div className={classes.defaultAddressHeading}>{defaultBadge}
                <LinkButton
                ...
                : null}
        <div className={defaultBadge ? classes.defaultAddress : classes.root}>
