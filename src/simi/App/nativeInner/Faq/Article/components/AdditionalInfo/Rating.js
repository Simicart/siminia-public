        ...
        <div className={classes.container_rating}>
            <div className={classes.rating_label}>
                <span>
                    {formatMessage({
                        id: 'helpFull',
                        defaultMessage: 'Did you find it helpful?'
                    })}
                </span>
                ...
                <div>
                    {!disable ? (
                        <>
                            {formatMessage({
                                id: 'thank',
                                defaultMessage: 'Thank for your vote!'
                            })}
                        </>
                    ) : (
                        <>
                            {formatMessage({
                                id: 'voted',
                                defaultMessage: 'You have voted already!'
                            })}
                        </>
                    )}
                </div>
