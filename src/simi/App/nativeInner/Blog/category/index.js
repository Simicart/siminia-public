...
const Category = props => {
    ...
    if (
        !resultData ||
        !resultData.mpBlogCategories ||
        !resultData.mpBlogCategories.items ||
        !resultData.mpBlogCategories.items[0]
    )
    ...
    return (
        <div className={`${classes.mainCtn} container`}>
            <Title>
                {cateData.meta_title ? cateData.meta_title : cateData.name}
            </Title>
            ...
            <div className={classes.blogRoot}>
                <div className={classes.blogListing}>
                    <BlogListing
                        classes={classes}
                        filterType="get_post_by_categoryId"
                        filterValue={cateData.category_id}
                    />
                </div>
