...
const GiftCardInformationForm = props => {
    ...
    const { activeAmount, gcMessage, delivery, currentTemplate } = giftCardData;
    ...
    const hasFromAndToField =
        currentTemplate && Object.keys(currentTemplate).length > 0
            ? typeof JSON.parse(currentTemplate.design).from !== 'undefined'
            : null;
    ...
    return (
        <div className={classes['wrapper-gift-card']}>
            <div
                className={
                    classes['giftcard-information'] +
                    ' ' +
                    classes['giftcard-information-amount']
                }
            >
                ...
                <div className={classes['giftcard-field-wrapper']}>
                    <ul className={classes['giftcard-amount']}>
                            ...
                            return (
                                ...
                                >
                                    <button
                                        type="button"
                                        className={
                                            classes['giftcard-design-button']
                                        }
                                    >
                                        <span>${amount}.00</span>
                                    </button>
                        ...
                        {allow_amount_range ? (
                            <li
                                className={
                                    classes['giftcard-design-input-container']
                                }
                            >
                                <input
                                    onFocus={() =>
                                        setActiveAmount(amounts.length)
                                    }
                                    onBlur={onAmountBlur}
            ...
            <div
                className={
                    classes['giftcard-information'] +
                    ' ' +
                    classes['giftcard-information-delivery']
                }
            >
                ...
                <div className={classes['giftcard-field-wrapper']}>
                    <ul className={classes['giftcard-delivery']}>
                        ...
                        {gift_card_type === 2 && (
                            <li
                                className={`${
                                    classes['giftcard-design-button-container']
                                } ${delivery === 3 ? classes.active : ''}`}
                            >
                                <button
                                    type="button"
                                    className={
            ...
            <div
                className={
                    classes['giftcard-information-delivery-content'] +
                    ' ' +
                    classes['fieldset']
                }
            >
                <div
                    className={
                        ...
                        classes['giftcard-information'] +
                        ' ' +
                        classes['giftcard-information-delivery-field']
                    }
                >
                    ...
                    <div className={classes['giftcard-note-wrapper']}>
                        <p className={classes.note}>
                            {gift_card_type === 2 && (
                                <span>
                                    You can print gift card on the confirmation
                                    email or the Gift Card in your account.
                                </span>
                            )}
                            {gift_card_type === 3 && (
                                <span>
                                    Please input shipping address when checking
                                    out.
                                </span>
                            )}
                        </p>
                ...
                {hasFromAndToField && (
                    <Fragment>
                        <div
                            className={
                                classes['field giftcard-information'] +
                                ' ' +
                                classes['giftcard-information-delivery-field']
                            }
                        >
                ...
                >
                    ...
                    <div className={classes['giftcard-note-wrapper']}>
                        ...
                        <p className={classes.note}>
                            <span>
                                {120 - gcMessage.length} characters remaining
                            </span>
                        </p>
                    </div>
                </div>
